...
const cases = [
  {
    ...
    description:
      "Your client was interrogated without being informed of his rights. Argue the confession should be suppressed.",
    difficulty: "Beginner",
    diffColor: "#4ADE80",
  ...
  },
  {
    ...
    description:
      "A software company claims your client failed to deliver on time. Defend the breach of contract claim.",
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "3rem" }}>
          ...
          >
            Select a case and argue as the defense. The AI judge and prosecutor
            respond to every argument you make.
          </p>
        </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div>
                ...
                <span style={{ fontSize: 13, color: "#6B7280" }}>
                  Argue against a real opponent. AI judge scores both sides
                  live.
                </span>
              </div>
            </div>
